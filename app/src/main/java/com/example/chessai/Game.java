...
public class    Game extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startTimerTap = findViewById(R.id.btStartTimer);
    ...
    private boolean isEndGame(GameState currentState){
        ...
        if(whiteWin){
            ResaultsIn resaultsIn = new ResaultsIn(seconds, "Победа");
            Paper.book().write(date.toString(), resaultsIn);
            ...
            ResaultsIn resaultsIn = new ResaultsIn(seconds, "Поражение");
            Paper.book().write(date.toString(), resaultsIn);
            running = false;
            seconds = 0;
            //make a dialog box informing of the win.
    ...
    public void startTimerTap(View view) {
        running = true;
    }
